...
function PointCollection() {
    ...
    this.update = function () {
        for (var i = 0; i < this.points.length; i++) {
            ...
            point.targetPos.x = d < 60 ? point.curPos.x - dx : point.originalPos.x;
            point.targetPos.y = d < 60 ? point.curPos.y - dy : point.originalPos.y;
...
function drawName(name, letterColors) {
    ...
    for (var j = 0; j < g.length; j++) {
        ...
        g[j].curPos.y = (canvasHeight / 2 - 120) + g[j].curPos.y;
        g[j].originalPos.x = (canvasWidth / 2 - offset / 2) + g[j].originalPos.x;
        g[j].originalPos.y = (canvasHeight / 2 - 120) + g[j].originalPos.y;
    }
